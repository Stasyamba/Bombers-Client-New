...
public class BomberBase extends CreatureBase implements IBomber {
    ...
    public function move(elapsedMilliSeconds:int):void {
        throw Context.Exception("Error in file BomberBase.as: method BomberBase.move can't be called")
    }

    public function explode(expl:IExplosion):void {
        throw  Context.Exception("Error in file BomberBase.as: method BomberBase.explode can't be called ")
    }

    public function kill():void {
        throw Context.Exception("Error in file BomberBase.as: method BomberBase.kill can't be called ")
    }
