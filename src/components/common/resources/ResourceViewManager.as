...
public class ResourceViewManager {
    ...
    [Embed(source="assets/pageworld/toppanel/resources/resourceAntimatterBig.png")]
    ...
    public function getResourceViewObject(resourceType:ResourceType):ResourceViewObject {
